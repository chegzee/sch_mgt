    ...
    d = (e, i, t, n) => {
      ...
      return (
        ...
        "12h" === i
          ...
          : { hour: d < 10 ? `0${d}` : d.toString(), minutes: u.toString() }
      );
    },
    c = (e, i, t) => {
      const n = Number(e);
    ...
    p = (e, i, t, n) => {
      if (e) {
        ...
        if ("string" == typeof e || "number" == typeof e) {
          const r = c(e, i, t),
            o = null == n ? void 0 : n.map(Number).includes(Number(e));
          return !(!r || o);
        }
      }
    };
      ...
      (this.clean = () => {
        ...
        const t =
            null === (e = this.tipsWrapper) || void 0 === e
              ? void 0
              : e.querySelectorAll("span.timepicker-ui-hour-time-12"),
          n =
            null === (i = this.tipsWrapper) || void 0 === i
              ? void 0
              : i.querySelectorAll("span.timepicker-ui-minutes-time");
                ...
                (h.innerHTML = e),
                  this.disabledTime &&
                    (Array.isArray(this.disabledTime) &&
                      (null === (s = this.disabledTime) || void 0 === s
                        ? void 0
                        : s.includes(e)) &&
                      (h.classList.add("timepicker-ui-tips-disabled"),
                      m.classList.add("timepicker-ui-tips-disabled")),
                    this.hour === this.disabledTime.removedStartedHour &&
                      (null ===
                        (l =
                          null === (a = this.disabledTime) || void 0 === a
                            ? void 0
                            : a.startMinutes) || void 0 === l
                        ? void 0
                        : l.includes(e)) &&
                      (h.classList.add("timepicker-ui-tips-disabled"),
                      m.classList.add("timepicker-ui-tips-disabled"),
                    ...
                    this.hour === this.disabledTime.removedEndHour &&
                      (null ===
                        (d =
                          null === (u = this.disabledTime) || void 0 === u
                            ? void 0
                            : u.endMinutes) || void 0 === d
                        ? void 0
                        : d.includes(e)) &&
                      (h.classList.add("timepicker-ui-tips-disabled"),
                      m.classList.add("timepicker-ui-tips-disabled"),
                      (h.tabIndex = -1))),
                  "24h" === this.clockType
                    ? (h.classList.add("timepicker-ui-value-tips-24h"),
                      n(h, "timepicker-ui-tips-disabled") || (h.tabIndex = 0))
                    : (h.classList.add("timepicker-ui-value-tips"),
                      n(h, "timepicker-ui-tips-disabled") || (h.tabIndex = 0)),
                  ...
                  "m3" === this.theme &&
                    (m.classList.add("m3"), h.classList.add("m3")),
                  (m.style.left = i + Math.sin(p) * r - m.offsetWidth + "px"),
                  (m.style.bottom =
                    t + Math.cos(p) * r - m.offsetHeight + "px"),
                  m.appendChild(h),
        ...
        (this.updateDisable = (e) => {
          ...
          const n =
              null === (i = this.tipsWrapper) || void 0 === i
                ? void 0
                : i.querySelectorAll("span.timepicker-ui-hour-time-12"),
            r =
              null === (t = this.tipsWrapper) || void 0 === t
                ? void 0
                : t.querySelectorAll("span.timepicker-ui-minutes-time");
          if (
          ...
          if (e) {
            ...
            if (!i || !t) return;
            n &&
              (i && "AM" === o && this._addClassesWithIncludes(n, i),
              t && "PM" === o && this._addClassesWithIncludes(n, t)),
              r &&
                s &&
                a &&
                ("AM" === o &&
                  ...
                  s.length > 0 &&
                    ...
                    (Number(l) === Number(d)
                      ? this._addClassesWithIncludes(r, s)
                      : Number(d) > Number(l) && this._addClasses(r)),
                  "00" === a[0] &&
                    1 === a.length &&
                    s.length > 0 &&
                    (Number(l) === Number(d)
                ...
                "PM" === o &&
                  ...
                  d === u && this._addClassesWithIncludes(r, a),
                  a.length > 0 &&
                    Number(d) === u - 1 &&
          ...
          null == e ||
            e.forEach(({ classList: e, children: i }) => {
              e.remove("timepicker-ui-tips-disabled"),
                i[0].classList.remove("timepicker-ui-tips-disabled"),
                (i[0].tabIndex = 0);
            });
        }),
        (this._addClasses = (e) => {
          null == e ||
            e.forEach(({ classList: e, children: i }) => {
              e.add("timepicker-ui-tips-disabled"),
                i[0].classList.add("timepicker-ui-tips-disabled"),
                (i[0].tabIndex = -1);
            });
        }),
        (this._addClassesWithIncludes = (e, i) => {
          null == e ||
            e.forEach(({ classList: e, children: t, textContent: n }) => {
              (null == i ? void 0 : i.includes(n)) &&
                (e.add("timepicker-ui-tips-disabled"),
                t[0].classList.add("timepicker-ui-tips-disabled"),
                (t[0].tabIndex = -1));
            });
        }),
  ...
  (e.TimepickerUI = class {
      ...
      (this.create = () => {
        ...
        (this.close = () =>
          f((...e) => {
            ...
            t &&
              ...
              null === (i = this.okButton) || void 0 === i || i.click()),
              ...
              setTimeout(() => {
                ...
                this._options.focusInputAfterCloseModal &&
                  ...
                  null !== this.modalElement &&
                    (this.modalElement.remove(), (this._isModalRemove = !0));
              }, 300),
              l(n);
        ...
        (this.destroy = (e) => {
          b
            .split(" ")
            .map((e) =>
              document.removeEventListener(e, this._mutliEventsMoveHandler, !1)
            ),
            document.removeEventListener(
              "mousedown",
              this._eventsClickMobileHandler
        ...
        (this._setTheme = () => {
          ...
          "crane-straight" === r
            ...
            : "crane-radius" === r
            ? n.forEach((e) => e.classList.add("crane-straight", "radius"))
        ...
        (this._setNormalizeClass = () => {
          ...
          null === (i = this.modalElement) ||
            ...
            null == t ||
              t.forEach((e) => e.classList.add("timepicker-ui-normalize"));
        }),
        ...
        (this._eventsBundle = () => {
          ...
          if (this._isModalRemove) {
            if (
              ...
              const e = new T({
                ...
                disabledTime: (
                  ...
                  ? null === (n = this._disabledTime) || void 0 === n
                    ? void 0
                    : n.value.rangeArrHour
                  : null ===
                      (o =
                        null === (r = this._disabledTime) || void 0 === r
                          ? void 0
                          : r.value) || void 0 === o
                  ? void 0
                  : o.hours,
              ...
              if ((e.create(), "24h" === this._options.clockType)) {
                new T({
                  ...
                  disabledTime: (
                    null ===
                      (a =
                        null === (s = this._disabledTime) || void 0 === s
                          ? void 0
                          : s.value) || void 0 === a
                      ? void 0
                      : a.isInterval
                  )
                    ? null === (l = this._disabledTime) || void 0 === l
                      ? void 0
                      : l.value.rangeArrHour
                    : null ===
                        (d =
                          null === (u = this._disabledTime) || void 0 === u
                            ? void 0
                            : u.value) || void 0 === d
                    ? void 0
                    : d.hours,
                ...
                (null === (c = this._disabledTime) || void 0 === c
                  ? void 0
                  : c.value.startType) ===
                (null === (p = this._disabledTime) || void 0 === p
                  ? void 0
                  : p.value.endType)
                  ? setTimeout(() => {
                      var i, t, n, r, o, s, a, l;
                        ...
                        e.updateDisable({
                          ...
                          minutesToUpdate: {
                            ...
                            removedEndHour:
                              null === (s = this._disabledTime) || void 0 === s
                                ? void 0
                                : s.value.removedEndHour,
                            removedStartedHour:
                              null === (a = this._disabledTime) || void 0 === a
                                ? void 0
                                : a.value.removedStartedHour,
                            actualHour: this.hour.value,
                            startMinutes:
                              null === (l = this._disabledTime) || void 0 === l
                                ? void 0
                                : l.value.startMinutes,
                          },
                        });
                    }, 300)
                  : setTimeout(() => {
                        ...
                        minutesToUpdate: {
                          ...
                          pmHours:
                            null === (i = this._disabledTime) || void 0 === i
                              ...
                              : i.value.pmHours,
                          amHours:
                            null === (t = this._disabledTime) || void 0 === t
                              ? void 0
                              : t.value.amHours,
                          activeMode:
                            null === (n = this.activeTypeMode) || void 0 === n
                              ? void 0
                              : n.textContent,
                        },
                      });
            ...
            this._setFlexEndToFooterIfNoKeyboardIcon(),
              ...
              this._handleOkButton(),
              this.modalElement &&
                (this._setShowClassToBackdrop(), this._handleBackdropClick()),
        ...
        (this._getInputValueOnOpenAndSet = () => {
          ...
          if (void 0 === t)
            return (
              ...
              void (
                "24h" !== this._options.clockType && this.AM.classList.add(k)
              )
            );
          let [n, o, s] = this.input.value.split(":").join(" ").split(" ");
          0 === this.input.value.length &&
            ((n = t.hour), (o = t.minutes), (s = t.type)),
            (this.hour.value = n),
            (this.minutes.value = o);
          const a = document.querySelector(`[data-type='${s}']`);
          "24h" !== this._options.clockType && a && a.classList.add(k),
            r(
              this._element,
              "show",
          ...
          this._clickTouchEvents.forEach((e) => {
            ...
            null === (i = this.okButton) ||
              ...
              i.addEventListener(e, () => {
                var e, i, t;
                const { clockType: n, disabledTime: o } = this._options,
            ...
            this.AM.addEventListener(e, (e) => {
              ...
              if (
                ...
                "12h" === this._options.clockType &&
                  (null === (i = this._options.disabledTime) || void 0 === i
                    ? void 0
                    : i.interval))
              ) {
                const e = new T({
                ...
                (null === (o = this._disabledTime) || void 0 === o
                  ...
                  : setTimeout(() => {
                      e.updateDisable(
                        Object.assign({}, this._getDestructuringObj(!0))
                      );
                    }, 300),
                  e.updateDisable();
              }
              r(this._element, "selectamtypemode", {
                ...
                minutes: this.minutes.value,
                type:
                  null === (s = this.activeTypeMode) || void 0 === s
                    ? void 0
                    : s.dataset.type,
                degreesHours: this._degreesHours,
                degreesMinutes: this._degreesMinutes,
          ...
          this._options.animation &&
            setTimeout(() => {
              ...
              null === (e = this.clockFace) ||
                void 0 === e ||
                e.classList.add("timepicker-ui-clock-animation"),
                setTimeout(() => {
                  var e;
                  null === (e = this.clockFace) ||
                    void 0 === e ||
                    e.classList.remove("timepicker-ui-clock-animation");
                }, 600);
            }, 150);
        }),
        ...
        (this._handleClasses24h = (e, i) => {
          ...
          this.hourTips &&
            "24h" === this._options.clockType &&
            (Number(n.textContent) > 12 || 0 === Number(n.textContent)
              ? this._setCircleClockClasses24h()
              : this._removeCircleClockClasses24h(),
            this._options.mobile ||
              null === (t = this.tipsWrapperFor24h) ||
              void 0 === t ||
              t.classList.remove("timepicker-ui-tips-wrapper-24h-disabled")),
              ...
              i.addEventListener(e, (e) => {
                ...
                if (
                  (null !== this.clockFace &&
                    this._handleAnimationSwitchTipsMode(),
                  "24h" === this._options.clockType &&
                    (Number(l.value) > 12 || 0 === Number(l.value)
                      ? this._setCircleClockClasses24h()
                      : this._removeCircleClockClasses24h(),
                    this._options.mobile ||
                  ...
                  "12h" === this._options.clockType &&
                    (null === (t = this._options.disabledTime) || void 0 === t
                      ? void 0
                      : t.interval))
                ) {
                  const e = new T({
          ...
          this._inputEvents.forEach((e) => {
            this.minutes.addEventListener(e, (e) => {
              ...
              if (
                ...
                "12h" === this._options.clockType &&
                  (null === (o = this._options.disabledTime) || void 0 === o
                    ? void 0
                    : o.interval))
              ) {
                const e = new T({
              ...
              r(this._element, "selectminutemode", {
                ...
                minutes: this.minutes.value,
                type:
                  null === (l = this.activeTypeMode) || void 0 === l
                    ? void 0
                    : l.dataset.type,
                degreesHours: this._degreesHours,
                degreesMinutes: this._degreesMinutes,
        ...
        (this._handleEventToMoveHand = (e) => {
          ...
          if (
            (("mousedown" !== be &&
              ...
              !n(ge, "timepicker-ui-tips-disabled")
                ? (e.preventDefault(), (this._isTouchMouseMove = !0))
                : (this._isTouchMouseMove = !1)),
          ...
          if (null !== this.minutesTips) {
            ...
            let e,
              t = we && o(Math.trunc((180 * we) / Math.PI) + 90, ye, 6);
            if (void 0 === t) return;
            if (
              (t < 0
              ...
              if (
                ...
                if (
                  (null ===
                    ...
                    ? void 0
                    : h.includes(e <= 9 ? `0${e}` : `${e}`)) &&
                  this.hour.value ===
                    (null ===
                      (b =
                        null === (v = this._disabledTime) || void 0 === v
                          ? void 0
                          : v.value) || void 0 === b
                      ? void 0
                      : b.removedEndHour) &&
                  (null === (g = this._disabledTime) || void 0 === g
                    ? void 0
                    : g.value.endType) ===
                    (null === (y = this.activeTypeMode) || void 0 === y
                      ? void 0
                      : y.textContent)
                )
                  return;
                if (
                  (null ===
                    (f =
                      null ===
                        (T =
                          null === (_ = this._disabledTime) || void 0 === _
                            ? void 0
                            : _.value) || void 0 === T
                        ? void 0
                        : T.startMinutes) || void 0 === f
                    ? void 0
                    : f.includes(e <= 9 ? `0${e}` : `${e}`)) &&
                  this.hour.value ===
                    (null ===
                      (w =
                        null === (x = this._disabledTime) || void 0 === x
                          ? void 0
                          : x.value) || void 0 === w
                      ? void 0
                      : w.removedStartedHour) &&
                  (null === (M = this._disabledTime) || void 0 === M
                    ? void 0
                    : M.value.startType) ===
                ...
                if (
                  (null === (E = this.activeTypeMode) || void 0 === E
                    ? void 0
                    : E.textContent) ===
                    (null === (H = this._disabledTime) || void 0 === H
                      ? void 0
                      : H.value.endType) &&
                  (((null ===
                    (N =
                    ...
                    ? void 0
                    : N.includes(e <= 9 ? `0${e}` : `${e}`)) &&
                    (null === ($ = this._disabledTime) || void 0 === $
                      ? void 0
                      : $.value.removedPmHour) === this.hour.value) ||
                    (null === (A = this._disabledTime) || void 0 === A
                      ? void 0
                      : A.value.pmHours
                          .map(Number)
                          .includes(Number(this.hour.value))))
                )
                  return;
                if (
                  (null === (O = this.activeTypeMode) || void 0 === O
                    ? void 0
                    : O.textContent) ===
                    (null === (I = this._disabledTime) || void 0 === I
                      ? void 0
                  ...
                  (((null ===
                    (F =
                      null ===
                        (j =
                          null === (W = this._disabledTime) || void 0 === W
                            ? void 0
                            : W.value) || void 0 === j
                        ? void 0
                        : j.startMinutes) || void 0 === F
                    ? void 0
                    : F.includes(e <= 9 ? `0${e}` : `${e}`)) &&
                    (null === (P = this._disabledTime) || void 0 === P
                      ? void 0
                      : P.value.removedAmHour) === this.hour.value) ||
                    (null === (D = this._disabledTime) || void 0 === D
                      ? void 0
                      : D.value.amHours
                          .map(Number)
                          .includes(Number(this.hour.value))))
            ...
            (this.minutes.value = e >= 10 ? `${e}` : `0${e}`),
              ...
              r(
                ...
                "update",
                Object.assign(
                  Object.assign({}, d(this.input, this._options.clockType)),
                  {
                    degreesHours: this._degreesHours,
                    degreesMinutes: this._degreesMinutes,
                    eventType: be,
                    type:
                      null === (q = this.activeTypeMode) || void 0 === q
                        ? void 0
                        : q.dataset.type,
                  }
                )
          ...
          if (null !== this.hourTips) {
            if (
              (null === (B = this.hour) || void 0 === B || B.classList.add(k),
              ...
              let e,
                i = we && o(Math.trunc((180 * we) / Math.PI) + 90, _e, 30);
              ...
              const t = (
                ...
                : "hours";
              if (
                (null === (z = this._disabledTime) || void 0 === z
                  ? void 0
                  : z.value.endType) ===
                (null ===
                  (R =
                ...
                if (
                  ...
                  typeof (null ===
                    (Z =
                      null === (Y = this._disabledTime) || void 0 === Y
                        ? void 0
                        : Y.value) || void 0 === Z
                    ? void 0
                    : Z.endType)
                  ...
                  if (
                    (null ===
                      (X =
                        null === (K = this._disabledTime) || void 0 === K
                          ? void 0
                          : K.value) || void 0 === X
                      ? void 0
                      : X.endType) ===
                      (null === (J = this.activeTypeMode) || void 0 === J
                        ? void 0
                        : J.textContent) &&
                    (null ===
                      (Q =
                      ...
                      ? void 0
                      : Q.startType) ===
                      (null === (ee = this.activeTypeMode) || void 0 === ee
                        ? void 0
                        : ee.textContent) &&
                    (null ===
                      (te =
                        null === (ie = this._disabledTime) || void 0 === ie
                          ? void 0
                          : ie.value[t]) || void 0 === te
                      ? void 0
                  ...
                  null ===
                    (re =
                      null === (ne = this._disabledTime) || void 0 === ne
                        ? void 0
                ...
                if (
                  (null === (oe = this._disabledTime) || void 0 === oe
                    ? void 0
                    : oe.value.startType) ===
                    (null === (se = this.activeTypeMode) || void 0 === se
                      ? void 0
                      : se.textContent) &&
                  (null === (ae = this._disabledTime) || void 0 === ae
                    ? void 0
                    : ae.value.amHours.includes(e.toString()))
                )
                  return;
                if (
                  (null === (le = this._disabledTime) || void 0 === le
                    ? void 0
                    : le.value.endType) ===
                    (null === (ue = this.activeTypeMode) || void 0 === ue
                      ? void 0
                      : ue.textContent) &&
                  (null === (de = this._disabledTime) || void 0 === de
                    ? void 0
                    : de.value.pmHours.includes(e.toString()))
                )
                  return;
              }
            ...
            if (
              (n(Ce || ge, "timepicker-ui-value-tips-24h") ||
                n(Ce || ge, "timepicker-ui-tips-wrapper-24h")) &&
              !n(Ce || ge, "timepicker-ui-tips-disabled")
            ) {
              let e,
                i = we && o(Math.trunc((180 * we) / Math.PI) + 90, _e, 30);
              ...
              const t = (
                null === (ce = this._disabledTime) || void 0 === ce
                  ? void 0
                  : ce.value.isInterval
              )
                ? "rangeArrHour"
              ...
              if (
                null ===
                  (me =
                    null === (pe = this._disabledTime) || void 0 === pe
                      ? void 0
            ...
            r(
              ...
              Object.assign(
                Object.assign({}, d(this.input, this._options.clockType)),
                {
                  ...
                  eventType: be,
                  type:
                    null === (he = this.activeTypeMode) || void 0 === he
                      ? void 0
                      : he.dataset.type,
                }
              )
          ...
          this._options.mobile ||
            ...
            b.split(" ").forEach((e) => {
              "touchstart" === e || "touchmove" === e || "touchend" === e
                ? document.addEventListener(e, this._mutliEventsMoveHandler, {
                    passive: !1,
                  })
          ...
          f(() => {
            ...
            if (n(this.modalElement, "mobile")) {
              ...
              const s = this.hour.value,
                ...
                l =
                  null === (r = this.activeTypeMode) || void 0 === r
                    ? void 0
                    : r.dataset.type;
              setTimeout(() => {
                this.destroy(),
                  ...
                  setTimeout(() => {
                    if (
                      ...
                      const e = "PM" === l ? "AM" : "PM";
                      this["PM" === l ? "PM" : "AM"].classList.add(k),
                ...
                this.destroy(),
                  ...
                  setTimeout(() => {
                    if (
                      ...
                      const e = "PM" === n ? "AM" : "PM";
                      this["PM" === n ? "PM" : "AM"].classList.add(k),
                        this[e].classList.remove(k);
                    }
                  }, 300);
              }, 300);
        ...
        (this._handlerClickHourMinutes = (e) =>
          i(this, void 0, void 0, function* () {
            ...
            o &&
              (n(s, "timepicker-ui-hour") || n(s, "timepicker-ui-minutes")
                ? (!1 !== a && !1 !== l) ||
                  (l || this.minutes.classList.add("invalid-value"),
                  a ||
                    null === (t = this.hour) ||
                    void 0 === t ||
                ...
                : !0 === a &&
                  !0 === l &&
                  (l && this.minutes.classList.remove("invalid-value"),
                  a &&
                    (null === (i = this.hour) ||
                      void 0 === i ||
                      i.classList.remove("invalid-value"))));
          })),
        (this._handleClickOnHourMobile = () => {
          document.addEventListener(
            "mousedown",
          ...
          setTimeout(() => {
            ...
            const t =
                null === (e = this.wrapper) || void 0 === e
                  ? void 0
                  : e.querySelectorAll('div[tabindex="0"]:not([disabled])'),
              r =
                null === (i = this.wrapper) || void 0 === i
                  ? void 0
                  : i.querySelectorAll('input[tabindex="0"]:not([disabled])');
              ...
              this.wrapper.addEventListener(
                ...
                ({ key: e, shiftKey: i, target: t }) => {
                  ...
                  if (
                    ("Tab" === e &&
                      (i
                        ? document.activeElement === s && a.focus()
                        : document.activeElement === a && s.focus()),
                    "Enter" === e &&
                      (n(r, "timepicker-ui-minutes") && this.minutes.click(),
                      n(r, "timepicker-ui-hour") && this.hour.click(),
                      n(r, "timepicker-ui-cancel-btn") &&
                        this.cancelButton.click(),
                      n(r, "timepicker-ui-ok-btn") && this.okButton.click(),
                      n(r, "timepicker-ui-keyboard-icon-wrapper") &&
                        this.keyboardClockIcon.click(),
                      n(r, "timepicker-ui-am") && this.AM.click(),
                      n(r, "timepicker-ui-pm") && this.PM.click(),
                      n(r, "timepicker-ui-value-tips") ||
                        n(r, "timepicker-ui-value-tips-24h")))
                  ) {
                    const {
                        left: e,
                        top: i,
                      ...
                      u = () => {
                        ...
                        n(l, "timepicker-ui-value-tips-24h")
                          ? null == l || l.dispatchEvent(r)
                          : null ===
                              (t = null == l ? void 0 : l.childNodes[0]) ||
                            void 0 === t ||
                            t.dispatchEvent(r),
                          (this._isTouchMouseMove = !1);
                      };
        ...
        (this._options = ((e, i) => Object.assign(Object.assign({}, i), e))(
          Object.assign(
            ...
            ((e) => {
              ...
              null === (a = this._element) || void 0 === a ? void 0 : a.dataset
            )
          ),
          v
        )),
        ...
        (this._eventsClickMobile = (e) => this._handlerClickHourMinutes(e)),
    ...
    _getDisableTime() {
      this._disabledTime = ((e) => {
        ...
        if (!i || Object.keys(i).length <= 0 || "Object" !== i.constructor.name)
          return;
        const { hours: n, interval: r, minutes: o } = i;
        if (r) {
          delete i.hours, delete i.minutes;
          const [e, n] = r.toString().split("-"),
            { hour: o, minutes: l, type: u } = d({ value: e.trimEnd() }, t),
            {
              hour: c,
              minutes: p,
              type: m,
          ...
          let h = s(o, c).map((e) =>
            "00" === e || 0 === Number(e) ? `0${Number(e)}` : `${Number(e)}`
          );
          const v = [],
            b = Number(l),
            k = Number(p);
          if (m === u)
            return (
              b > 0 && k <= 0
                ? (v.push(h[0], h[h.length - 1]), (h = h.slice(1, -1)))
                : k < 59 && k > 0 && b <= 0
                ? (v.push(void 0, h[h.length - 1]), (h = h.slice(0, -1)))
                : k > 0 && b > 0
                ? (v.push(h[0], h[h.length - 1]), (h = h.slice(1, -1)))
                : 0 === k &&
                  0 === b &&
            ...
            return (
              b > 0 && k <= 0
                ? (t.push(i[i.length - 1]),
                  ...
                  e.splice(0, 1))
                : k < 59 && k > 0 && b <= 0
                ? (n.push(e[0]), t.push(i[i.length - 1]), i.splice(-1, 1))
                : k > 0 && b > 0
                ? (t.push(i[i.length - 1]),
                  n.push(e[0]),
                  i.splice(-1, 1),
                ...
                : 0 === k &&
                  0 === b &&
                  (t.push(i[i.length - 1]), n.push(e[0]), i.pop()),
              {
                value: {
                  isInterval: !0,
                  endType: m,
      ...
      if (o) {
        ...
        throw (
          ...
          (null === (i = this.input) || void 0 === i
            ...
            (null === (n = this.input) || void 0 === n || n.after(d)),
    ...
    _setOnStartCSSClassesIfClockType24h() {
      if ("24h" === this._options.clockType) {
        ...
        this.input.value.length > 0 && (e = this.input.value.split(":")[0]),
