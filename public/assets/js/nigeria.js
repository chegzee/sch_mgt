class Nigeria {
    ...
    static stateLGA = {
        ...
        "KANO": ["Ajingi", "Albasu", "Bagwai", "Bebeji", "Bichi", "Bunkure", "Dala", "Dambatta", "Dawakin Kudu", "Dawakin Tofa", "Doguwa", "Fagge", "Gabasawa", "Garko", "Garun Mallam", "Gaya", "Gwale", "Gwarzo", "Kabo", "Kano Municipal", "Karaye", "Kibiya", "Kiru", "Kumbotso", "Kunchi", "Kura", "Madobi", "Makoda", "Minjibir", "Nasarawa", "Rano", "Rimin Gado", "Rogo", "Shanono", "Sumaila", "Takai", "Tarauni", "Tofa", "Tsanyawa", "Tudun Wada", "Ungogo", "Warawa", "Wudil"],
    ...
    constructor(state) {
        ...
        //
        if (Nigeria.state === '') {
            Object.keys(Nigeria.stateLGA).forEach(function (v) {
                Nigeria._return.push({id: v, text: v});
            });
        } else {
            for (const [i, v] of Object.entries(Nigeria.stateLGA)) {
                if (Nigeria.state !== i) continue;
                //console.log(i, v);
                v.forEach(function (v_) {
                    Nigeria._return.push({id: v_, text: v_});
                });
            }
        }
        //
        return Nigeria._return;
    }
}