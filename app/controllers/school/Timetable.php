...
class Timetable extends Controller
{
    ...
    public function __construct()
    {
        ...
        // var_dump($this->data['params']);exit;
        ...
        $classRoutine = $this->model('SystemData')->getClassRoutine(array("class_code" => $this->user->class_code, "term_code"=>$this->user->term));
        $this->data["timetable"] = json_decode($classRoutine->timetable);
        $this->data["term"] = $this->model("SystemData")->getTerm(array("code"=> $this->user->term));
        $this->data['subjectsobj'] = $this->model('SystemData')->getSubjects(array("_option2" => "class_code", "_option"=>"object", "class_code"=>$this->user->class_code));
    ...
    public function index()
    {
        ...
        // body
        $this->view('school/timetable', $this->data);
        //
