        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <div class="dataTables_wrapper">
                    <table id="table-teacher" class="table table-striped table-bordered table-sm nowrap w-100 datatableList">
                        <thead>
                            <tr>
...
<script>
    ...
    $(function () {
        ...
        // /////////////////////////////////////////////////////////////////////////////////////////
        let tableTeacher = $("#table-teacher").DataTable();
    
        let loadTeacher = (json) => {
            
            // dataTables
            let url = "<?php echo URL_ROOT ?>/school/teachers/_list/?user_log=<?php echo $data['params']['user_log'] ?>";
