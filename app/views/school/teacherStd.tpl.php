        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <nav id="modalNav" class="nav nav-tabs nav-gap-x-1">
                    ...
                    <a class="nav-link has-icon other-link" href="#page_3" data-toggle="tab"><i class="fa fa-pen mr-2 fs-10"></i><span style="color: black;">Result</span></a>
                    <a class="nav-link has-icon other-link" href="#page_4" data-toggle="tab"><i class="fa fa-folder mr-2 fs-10"></i><span style="color: black;">Document</span></a>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="page_3">
                        ...
                        <button type="button" class="rpt_button" onclick="printStudentReport({std_code: [$('#std_code').val()], term: [$('#term_code').val()], export: 'PDF', db: 'student', single: '1' })" style=""><i class="fa fa-print"></i> Print</button>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="border-right:1px solid black;border-bottom:1px solid black;text-align:center;height:50px;">
                                            <span style="cursor:pointer" onclick="saveTableAttendance()"><i class="fa fa-save mr-2"></i></span> ATTENDANCE RECORDS
                                        </td>
                                            ...
                                            <table style="border:1px solid black;font-weight:bold;width:100%" id="table-attendance">
                                                <tbody>
                                                    <tr style="border-bottom:1px solid black" id="no_of_days_absent">
                                                        <td style="text-align:left;border-right:1px solid black;">No. of days absent</td>
                                                        <td style="text-align:center;border-right:1px solid black;width:50px;overflow:hidden" contenteditable="true"></td>
                                                    </tr>
                                                    <tr style="border-bottom:1px solid black" id="no_of_days_present">
                                                        <td style="text-align:left;border-right:1px solid black;">No. of days present</td>
                                                        <td style="text-align:center;border-right:1px solid black;width:50px;overflow:hidden" contenteditable="true"></td>
                                                    </tr>
                                                    <tr style="border-bottom:1px solid black" id="no_of_days_late">
                                                        <td style="text-align:left;border-right:1px solid black;">No. of days late</td>
                                                        <td style="text-align:center;border-right:1px solid black;width:50px;overflow:hidden" contenteditable="true"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                    ...
                    <div class="tab-pane" id="page_6">
                        <div>
                            <button id="save_activity_btn" class="btn-fill-lg bg-blue-dark btn-hover-yellow" style="float:left;" onclick="saveActivities();" disabled><i class="fa fa-cart-shopping"></i> Add</button>
                            <button type="button" id="print_invoice_btn" class="print_invoice_btn" style="float:left;"  onclick="printInvoice({invoice_code: [$('#invoice_code').val()], term: [$('#term_code').val()], export: 'PDF', db: 'student', single: '1' })" disabled><i class="fa fa-print"></i> Invoice</button>
                            <button type="button" id="gen_invoice_btn" class="gen_invoice_btn" style="float:right;"  onclick="createInvoiceSingle({std_code: [$('#std_code').val()] })" disabled><i class="fa fa-bible"></i> Create Invoice</button>
                            <button type="button" id="create_receipt_btn" class="gen_invoice_btn" style="float:right;"  onclick="createInvoiceSingle({receipt_code: [$('#receipt_code').val()] })" disabled><i class="fa fa-print" ></i> Print Receipt</button>
                        </div>
                        <!-- attendance -->
                        <div class="row">
                            <div class="plist">
...
<script>
    ...
    let saveTableAttendance = (e)=>{
        if(!confirm("You are about to save attendance record"))return;
    ...
    // /////////////////////////////////////////////////////////////////////////////////////////
    ////// for saving student and subject ////////////////////
    ...
    var loadStudent = (json) => {
        ...
        // dataTables
        let url = "<?php echo URL_ROOT ?>/school/teacherStd/_list/?user_log=<?php echo $data['params']['user_log'] ?>";
